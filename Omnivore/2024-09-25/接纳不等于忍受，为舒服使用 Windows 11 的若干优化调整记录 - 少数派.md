...
总之这个命令执行后系统将自动重启，此后初始化过程中的网络配置会额外出现「我没有 Internet 连接」选项，再点击「继续执行受限设置」后续即可配置离线账户。而如果你已经联网，看到强制要求登录 Microsoft 账户界面后才寻找使用离线账户账户的方法，此时只通过上面的命令是不够的——至少从我唯一的一次经历来看输入命令后重启后仍然会自动配置好网络，此时则需要先输入 `devmgmt` 打开设备管理器、禁用无线网卡，然后再输入 `oobe\BypassNRO`。
...
* [Intel](https://sspai.com/link?target=https%3A%2F%2Fwww.intel.com%2Fcontent%2Fwww%2Fus%2Fen%2Fdownload-center%2Fhome.html)
* [AMD](https://sspai.com/link?target=https%3A%2F%2Fwww.amd.com%2Fen%2Fsupport%2Fdownload%2Fdrivers.html)
* [NVIDIA](https://sspai.com/link?target=https%3A%2F%2Fwww.nvidia.com%2Fdownload%2Findex.aspx)

至于特殊的「鸡生蛋」情况──无线网卡驱动──没有无线网卡驱动无法联网、无法联网就无法通过 Windows 更新升级无线网卡驱动，可以通过 USB 网卡或者手机共享网络连接，或者直接下载驱动到 U 盘，然后在设备管理器中手动更新。对于 OEM 设备可以去对应官网寻找驱动支持，对于个人 DIY PC 主要前往主板官网下载最新驱动，当然如果你知道具体网卡型号（例如常用的 [Intel AX210](https://sspai.com/link?target=https%3A%2F%2Fwww.intel.com%2Fcontent%2Fwww%2Fus%2Fen%2Fdownload%2F19351%2Fintel-wireless-wi-fi-drivers-for-windows-10-and-windows-11.html)）也可以直接去对应官网下载。
...
![](https://proxy-prod.omnivore-image-cache.app/0x0,sR1d7bSfbvwroXFNk-vJs0X3G513qPBiy-qFOJCwZSXs/https://cdnfile.sspai.com/2024/09/10/47d9e3f4db9f77492da7714f20e37c02.png?imageView2/2/format/webp)
...
至于彻底禁止 Windows 更新，其实上文提到的通过注册表推迟到一个不可能的天数便可达到类似效果，除此以外还可以通过编辑组策略、修改更新服务器到一个空地址、借助诸如 Windows Update [Blocker](https://sspai.com/link?target=https%3A%2F%2Fwww.sordum.org%2F9470%2Fwindows-update-blocker-v1-8%2F) 等第三方工具等。这里不再一一赘述。
...
![](https://proxy-prod.omnivore-image-cache.app/0x0,sQx0WWluGB3vO1EDSE7XMDxQJuY8XOUq37uFJgssND-s/https://cdnfile.sspai.com/2024/09/10/5f5e80651c83ef5cdf112ba10f85f30a.png?imageView2/2/format/webp)
...
![](https://proxy-prod.omnivore-image-cache.app/0x0,s3eJpISRPgceKfpccLTxObqHAUFl8bWJJ-6zt47hnaD8/https://cdnfile.sspai.com/2024/09/25/e039d47630f724b02c66190084525160.png?imageView2/2/format/webp)

搜索栏在任务栏中的开始菜单附近，但是它的设置项目却在「隐私和安全性 > 搜索权限」中。而微软也往此处插入了一些「推荐内容」，需要在关闭设置项目最后的「显示搜索要点」。

![](https://proxy-prod.omnivore-image-cache.app/0x0,sTPprP71OnojRlxjY_TJi7HpQj8cHQVJUvFGl3ufujvk/https://cdnfile.sspai.com/2024/09/10/68ea80f65127a383ff6242db03bd7109.png?imageView2/2/format/webp)
...
![](https://proxy-prod.omnivore-image-cache.app/0x0,scwiTavmr3OGxCM3NDvdDpnD8wa6HihLMYqIUWTKzqhk/https://cdnfile.sspai.com/2024/09/25/41c46204fbf3158fe9332173ff13de2a.png?imageView2/2/format/webp)
...
![](https://proxy-prod.omnivore-image-cache.app/0x0,s6HuKd7agwZoPKMz0VJFBEpOVFkRNZsjf_CrnaKvwo0s/https://cdnfile.sspai.com/2024/09/25/80525bb5adbee29d8c2035de0d62b2de.png?imageView2/2/format/webp) 

![](https://proxy-prod.omnivore-image-cache.app/0x0,sjVdeomz-0g5XK1z1cUHPP0GXn7nxHRdA0dPWmRCSJww/https://cdnfile.sspai.com/2024/09/25/8b3cc35eead51ff8e8cf26d757d6cef0.png?imageView2/2/format/webp) 
...
![](https://proxy-prod.omnivore-image-cache.app/0x0,stljW0DkbUj8GH6juzvwLmYjQkkf18QjCW-UlTsfdT2k/https://cdnfile.sspai.com/2024/09/06/d6c382b2f2768076ecd181ef9b245c67.jpg?imageView2/2/format/webp)
...
![](https://proxy-prod.omnivore-image-cache.app/0x0,sG4xzlGKbdI9vFdKqeqcPMnZXAt8f0ey8ZPZdkNqCed0/https://cdnfile.sspai.com/2024/09/25/5277b5f02fe6094fcedc64416f7e8f0e.png?imageView2/2/format/webp)
...
![](https://proxy-prod.omnivore-image-cache.app/0x0,sx7YEI7o9-7OweivI9lPNKOsbYzI4Ro_VD6WVhMfChFk/https://cdnfile.sspai.com/2024/09/10/7201d7c4213c9e95a4c7b237b22ec4ff.png?imageView2/2/format/webp)
...
在 Windows 10 之时我还能接受通过 [noMeiryoUI](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FTatsu-syo%2FnoMeiryoUI) 软件方式修改默认系统字体为更纱黑体，配合 [MacType](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Fsnowie2000%2Fmactype) 软件实现更好的字体渲染效果（一定程度上抵消 ClearType 在高分屏的负优化）。虽然 noMeiryoUI 依然兼容 Windows 11，Windows 11 上更多的系统组件、官方应用并不默认遵守该设置，导致字体修改效果十分有限。

因此在 Windows 11 上我选择一种比较 dirty 但是好用的手段──将其他字体（例如更纱黑体）重新打包成伪装的「微软雅黑」并移动至 Windows 字体文件夹下以欺骗系统。[chenh96/yahei-sarasa](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Fchenh96%2Fyahei-sarasa) 提供了一个截止本文修改时仍运行良好的 Python 脚本自动将更纱黑体伪装为微软雅黑和宋体。
...
Windows 的色彩管理仍是一个相对混乱的领域，短期内是不指望能和 macOS 相提并论。但是 Windows 11 还是比前代 Windows 10 在 HDR 支持上有 [明显改进](https://sspai.com/link?target=https%3A%2F%2Fdevblogs.microsoft.com%2Fdirectx%2Fauto-color-management%2F)，至少算是过了及格线。
...
![](https://proxy-prod.omnivore-image-cache.app/0x0,sDgiLhXqLkUsIraxP2OWt3REkx47Zy6hTCrfIyHiJ-wY/https://cdnfile.sspai.com/2024/09/06/33057212dd843331dad8852d733b9002.jpg?imageView2/2/format/webp)
...
此外，对于说不上发烧但还算追求音质的有线耳机用户，如果使用的 N 卡，在没有「小尾巴」的时候可以将耳机线插在显示器上而非主板上，这样会走的 NVIDIA High Denifinition Audio 往往比主板声卡好不少（一耳朵提升）。具体不展开了。
...
如果你在电源设置中发现缺少某些设置项目，除了一个个查注册表，更方便的方法是通过 [PowerSettingsExplorer](https://sspai.com/link?target=https%3A%2F%2Fforums.guru3d.com%2Fthreads%2Fwindows-power-plan-settings-explorer-utility.416058%2F) 这个仅调用 [Power Management Functions](https://sspai.com/link?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fwindows%2Fwin32%2Fpower%2Fpower-management-functions%3Fredirectedfrom%3DMSDN) 接口的小工具来调出那些被隐藏的选项。在 Windows 11 中与大小核调度策略有关的隐藏高级电源设置有：
...
个人认为更好用的还属控制面板中的「备份和还原（Windows 7）」，不仅支持对系统分区全量备份，还支持制作系统镜像和系统恢复盘。虽然 Windows 在 [知识库](https://sspai.com/link?target=https%3A%2F%2Fsupport.microsoft.com%2Fzh-cn%2Fwindows%2Fsystem-configuration-tools-in-windows-f8a49657-b038-43b8-82d3-28bea0c5666b) 中鼓励大家尽可能使用设置取代控制面板，无奈前者体验还偏偏不如后者。

此外，[Dism++](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FChuyu-Team%2FDism-Multi-language) 也提供系统备份功能，同时支持不添加文件的增量备份（不算快照）。Dism（Deployment Imaging and Management）是 Windows 自带的一个工具，用于安装和维护 Windows 映像，Dism++ 只是将常用命令封装成 GUI 便于操作，并没有额外单独实现，这种备份也算是半官方方法。
...
你说得对，可以尝试开源方案 [VeraCrypt](https://sspai.com/link?target=https%3A%2F%2Fveracrypt.eu%2Fen%2FDocumentation.html)，支持 Windows 11 系统加密，在普通分区加解密上还提供更好的跨平台支持，但是 VeraCrypt 不支持 TPM 且由于理念不合永远不会支持，在和 Windows 集成上肯定也不如 BitLocker 无感。看你愿不愿意拿所谓的安全换便利了。
...
![](https://proxy-prod.omnivore-image-cache.app/0x0,siX2HIO3OOwWxyiKpr2hQBazG8FjgAwoVLs14Ij3gQwU/https://cdnfile.sspai.com/2024/09/06/e25b397a5e5c3dc2080130ea4b87d247.jpg?imageView2/2/format/webp)
...
* 官网：[Scoop](https://sspai.com/link?target=https%3A%2F%2Fscoop.sh%2F)
* GitHub：[ScoopInstaller/Scoop](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FScoopInstaller%2FScoop)

Windows 本身其实一直缺乏一个好用的包管理器，不提不如 Linux 各发行版的，就连 HomeBrew 类似产品都没有。微软官方推行的 [WinGet](https://sspai.com/link?target=https%3A%2F%2Flearn.microsoft.com%2Fen-us%2Fwindows%2Fpackage-manager%2F) 严格意义上称不上包管理器，它并没有提供统一的包格式，而是依赖于各个软件的安装程序下载下来静默安装，正如 HomeBrew Cask。[Scoop](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FScoopInstaller%2FScoop) 才稍微有些包管理器的感觉，安装同时也能自动配置环境变量，在迁移时备份还原更方便。如果不介意添加多余的工具，用 [UniGetUI](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Fmarticliment%2FUniGetUI) 可以一次性管理 WinGet, Scoop, Chocolatey, Pip, Npm, .NET Tool 和 PowerShell Gallery 多个包管理器。
...
* GitHub：[valinet/ExplorerPatcher](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Fvalinet%2FExplorerPatcher)
* Wiki: [ExplorerPatcher wiki](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Fvalinet%2FExplorerPatcher%2Fwiki)
...
![](https://proxy-prod.omnivore-image-cache.app/0x0,sFq_T848j8YHr9NoCBjG6-dY3yfmRJhBqRCHWzAAd7Mk/https://cdnfile.sspai.com/2024/09/25/89b2f4c962f825e967782c9a6aa1cd8d.jpg?imageView2/2/format/webp)

虽然前面系统设置部分已经提到部分调整手段，但是这些调整往往需要手动修改注册表等隐藏更深的手段。如果你不想折腾，亦或是觉得这些调整不够全面，可以尝试 [ExplorerPatcher](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Fvalinet%2FExplorerPatcher) 这款开源插件，不仅可以将任务栏、开始菜单、右键菜单一并调回 Windows 10 风格，还有许多诸如屏蔽 Office Key、禁止文件高级搜索、取消窗口圆角等功能。

虽然在部分时刻，例如系统更新后，ExplorerPatcher 偶有失效，但考虑到开源插件能做到这种程度，完全配得上其自称的「增强 Windows 上的工作环境」宗旨，无需吝啬赞美。

### PowerPlanSwitcher - 电源计划切换

* GitHub：[petrroll/PowerSwitcher](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Fpetrroll%2FPowerSwitcher)
* 安装：[Microsoft Store](https://sspai.com/link?target=https%3A%2F%2Fwww.microsoft.com%2Fen-us%2Fstore%2Fp%2Fpowerplanswitcher%2F9nblggh556l3)

开源项目 [Power plan switcher](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Fpetrroll%2FPowerSwitcher) 可以在系统托盘中切换电源计划，支持快捷键、自动切换等功能。

![](https://proxy-prod.omnivore-image-cache.app/0x0,sULL2iQ1vatKaHEuw_zxeWTJT_fYUlmWodHVQhHEm1Oo/https://cdnfile.sspai.com/2024/09/06/8569931f9235000584f77eca3de55f86.jpg?imageView2/2/format/webp)
...
* GitHub：[microsoft/PowerToys](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Fmicrosoft%2FPowerToys)
* 文档：[Microsoft PowerToys](https://sspai.com/link?target=https%3A%2F%2Flearn.microsoft.com%2Fzh-cn%2Fwindows%2Fpowertoys%2F)

> Microsoft PowerToys 是一组实用工具，可帮助高级用户调整和简化其 Windows 体验，从而提高工作效率。
> 
> ——[Microsoft PowerToys](https://sspai.com/link?target=https%3A%2F%2Flearn.microsoft.com%2Fzh-cn%2Fwindows%2Fpowertoys%2F)
...
同时还有诸如 Color Picker、Image Resizer、Text Extractor 等一众小工具，让你免去管理一堆小工具的烦恼、也减少众多工具中出现某几个断更的风险。PowerToys 也有丰富的 [第三方插件](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Fmicrosoft%2FPowerToys%2Fblob%2Fmain%2Fdoc%2FthirdPartyRunPlugins.md)，例如 [PowerTranslator](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FN0I0C0K%2FPowerTranslator) 在 PowerToys Run 中直接翻译文本、  
[EverythingPowerToys](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Flin-ycv%2FEverythingPowerToys) 在 PowerToys Run 中通过 Everything 检索文件、  
[ChatGPTPowerToys](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Fferraridavide%2FChatGPTPowerToys) 在 PowerToys Run 中调用 ChatGPT、  
[PowerToys-Run-Spotify](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Fwaaverecords%2FPowerToys-Run-Spotify) 在 PowerToys Run 中让 Spotify 放歌等等。

各个工具具体用法这里不再赘述，PowerToys 每个工具页面都有详尽的描述。

### Everything - 文件搜索

* 官网：[voidtools](https://sspai.com/link?target=https%3A%2F%2Fwww.voidtools.com%2F)
...
* GitHub: [ShadowWhisperer/Remove-MS-Edge](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FShadowWhisperer%2FRemove-MS-Edge)
...
[Remove MS Edge](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FShadowWhisperer%2FRemove-MS-Edge) 这个工具旨在通过可执行文件或批处理脚本以静默方式彻底卸载 Microsoft Edge，并提供保留 WebView 选项。
...
* 官网：[AutoHotKey](https://sspai.com/link?target=https%3A%2F%2Fwww.autohotkey.com%2F)
* GitHub：[AutoHotKey/AutoHotkey](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FAutoHotkey%2FAutoHotkey)

虽然 PowerToys 的 Keyboard Manager 也能完成一些键盘映射的工作。但是 AutoHotKey 作为完整脚本语言，功能更加强大，可以实现更多的自定义功能。

例如我对于大写锁定键的需求很小，但是却又有频繁的中英文输入法切换和自定义快捷键需求。自定义快捷键时一般会引入 [Hyper 键](https://sspai.com/link?target=https%3A%2F%2Fdeskthority.net%2Fwiki%2FHyper%5Fkey) 的概念，在 Windows 上即同时按下 `Ctrl`、`Shift`、`Alt`、`Win` 四个键，这样可以避免与系统快捷键冲突。
...
* 官网：[Ditto Clipboard Manager](https://sspai.com/link?target=https%3A%2F%2Fditto-cp.sourceforge.io%2F)
* GitHub：[Ditto Clipboard Manager](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Fsabrogden%2FDitto)
...
* ~~官网~~ 似乎域名已过期
* GitHub：[QL-Win/QuickLook](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FQL-Win%2FQuickLook)

在 macOS Finder 中，[Quick Look](https://sspai.com/link?target=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FQuick%5FLook) 赋予空格快速预览文件夹属性或者多种文档内容功能——俗称「一指禅」。Windows 用户一直垂涎这种功能，虽然 Windows 资源管理器也可以通过侧边栏预览，但是这种方式开启后任何选中都会预览，占用大量资源，同时支持的文件内容类型也有限，还会有反馈带来奇怪 bug。

这催生了 Windows 同名第三方开源插件 [QuickLook](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FQL-Win%2FQuickLook)，行为几乎与 macOS Quick Look 一致，通过空格快速预览，同时支持通过 [引入插件的插件](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FQL-Win%2FQuickLook%2Fwiki%2FAvailable-Plugins) 形式支持预览 markdown、jupyter notebook、电子书等更多格式文件，并且支持在 Directory Opus、[Files](https://sspai.com/link?target=https%3A%2F%2Ffiles.community%2F)、[OneCommander](https://sspai.com/link?target=https%3A%2F%2Fonecommander.com%2F) 等第三方文件管理器中使用。

### ThreeFingerDragOnWindows - 触控板三指拖拽

* GitHub：[ClementGre/ThreeFingerDragOnWindows](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FClementGre%2FThreeFingerDragOnWindows)
...
好在可以通过插件 [ThreeFingerDragOnWindows](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FClementGre%2FThreeFingerDragOnWindows) 在 Windows 上实现 macOS 的三指拖拽，依赖 `.NET` 运行环境实现。使用前请确保通过触摸板设置中禁用「轻点两次并拖动以多选」行为和所有默认的三指轻扫行为，这样拖动操作才不会受到干扰。

### Windows Auto Dark Mode - 自动深色模式

* GitHub：[AutoDarkMode/Windows-Auto-Night-Mode](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FAutoDarkMode%2FWindows-Auto-Night-Mode)
* Wiki: [Windows Auto Dark Mode wiki](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FAutoDarkMode%2FWindows-Auto-Night-Mode%2Fwiki)

相较于 Windows 10 主题色、背景和明暗模式的割裂设置，Windows 11 将更统一、更完善的「个性化 - 主题」设置提到更优先位置，并提供若干预设主题。但是 Windows 11 仍然没有 macOS 那样的自动切换深色模式功能。[Windows Auto Dark Mode](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FAutoDarkMode%2FWindows-Auto-Night-Mode) 支持通过设定固定时间或跟随该定位的日出日落时间自动切换深色模式，同时可以自定义深色、浅色模式对应主题。

### Link Shell Extension - 快速管理文件链接

* 官网：[Link Shell Extension](https://sspai.com/link?target=https%3A%2F%2Fschinagl.priv.at%2Fnt%2Fhardlinkshellext%2Flinkshellextension.html)
...
虽然 Windows 自带输入法对于绝大多数用户已经足够好用。但是我有跨设备需求，特别是需要兼容 macOS 和 Windows 双系统，这导致明明两者的系统自带输入法都可圈可点我都率先排除。而高度自由、高度定制的 RIME 进入我考虑范围。在 Windows 上通过 [Weasel](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Frime%2Fweasel)、在 macOS 上通过 [Squirrel](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2Frime%2Fsquirrel) 实现 RIME 输入法的部署，在 Linux 上还有诸如 `ibus-rime` 等多种版本。

但 RIME 的高度自由伴随的也是较高准入门槛。好在开源项目 [oh-my\-rime](https://sspai.com/link?target=https%3A%2F%2Fgithub.com%2FMintimate%2Foh-my-rime) 及其 [配套配置教程](https://sspai.com/link?target=https%3A%2F%2Fwww.mintimate.cc%2Fzh%2Fguide%2F) 算是相当程度上降低这种门槛。但这种打包配置并未限制你设置自由度，你依然可以根据自己的需求自行修改配置文件，例如取消 `Shift` 切换中英文、更改翻页快捷键和以词定字快捷键等等。
...
![](https://proxy-prod.omnivore-image-cache.app/0x0,sdUUd3Hs-YUrxKJN6WjVVqxVd6yWQEICYmH3RZ2ZXrHs/https://cdnfile.sspai.com/2024/09/06/6e52b1ecd927115a71239e049b78ea0f.jpg?imageView2/2/format/webp) 

![](https://proxy-prod.omnivore-image-cache.app/0x0,sKZAKyV_McoLMOZeW06dQ14clFEHZ1DqJkhwHntGmqAw/https://cdnfile.sspai.com/2024/09/06/c1b6b3127e81eb5a29ba7548c338288d.jpg?imageView2/2/format/webp) 
