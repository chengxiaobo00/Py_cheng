---
id: be7356ed-c854-48b0-a66b-45f216deead4
title: |
  Omninove 通过 obsidian-omnivore 与 Obsidian 集成
tags:
  - Omnivore
date_saved: 2023-09-23 00:38:17
date_published: 2023-05-30 08:00:00
dv_state: "[[{{#lowerCase state lowerCase|{{ > lowerCase state lowerCase]]"
---

# Omninove 通过 obsidian-omnivore 与 Obsidian 集成
[[Omnivore]]

[Read on Omnivore](https://omnivore.app/me/obsidian-omnivore-18abdbe7288)
[Read Original](https://docs.omnivore.app/zh/integrations/obsidian.html)
...
* [特点](#特点)
* [安装](#安装)
* [自定义从 Omnivore 同步到 Obsidian 的数据](#自定义从-omnivore-同步到-obsidian-的数据)
* [控制导入到 Obsidian 数据的布局](#控制导入到-obsidian-数据的布局)  
   * [Mustache 模板语言](#mustache-模板语言)  
   * [模板中可用的变量](#模板中可用的变量)  
   * [导入完整的文章内容](#导入完整的文章内容)  
   * [模板中的函数图](#模板中的函数图)  
   * [Front Matter](#front-matter)  
   * [Front Matter模板](#front-matter模板)
* [将所有文章同步到一个笔记中](#将所有文章同步到一个笔记中)
* [预定的同步](#预定的同步)
* [另一种安装 obsidian-omnivore 插件方法](#另一种安装-obsidian-omnivore-插件方法)
...
[黑曜石同步筛选器](https://docs.omnivore.app/zh/integrations/images/obsidian-sync-filter.png)
...
笔记中的内容是供人阅读的，而元数据中的内容是为了让程序能够更好地读取，例如社区插件或Obsidian本身。front matter包含了元数据，它以YAML格式存放在笔记的顶部。你可以用逗号来分隔多个元数据，并且你可以用`metadata==alias`的格式来自定义别名。例如，`date_saved==date`会在front matter中生成。
...
可用的变量和[模板中可用的变量](#%E6%A8%A1%E6%9D%BF%E4%B8%AD%E5%8F%AF%E7%94%A8%E7%9A%84%E5%8F%98%E9%87%8F)相同。
